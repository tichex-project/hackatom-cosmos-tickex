...
See the [testnet repo](https://github.com/cosmos/testnets) for details on which version is needed for which testnet, and the [Gaia release page](https://github.com/tichex-project/hackatom-cosmos-tichex/releases) for details on each release.
