...
```
git clone git@github.com:tichex-project/hackatom-cosmos-tichex
```
...
Once signatures are generated, they could be uploaded to gaia's dedicated repository: https://github.com/tichex-project/hackatom-cosmos-tichex.sigs.
