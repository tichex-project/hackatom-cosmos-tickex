...
If you want to open a PR on Gaia to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/tichex-project/hackatom-cosmos-tichex/tree/master/CONTRIBUTING.md)
...
built from the files in this (`/docs`) directory for [master](https://github.com/tichex-project/hackatom-cosmos-tichex/tree/master/docs)
...
Then, edit the `swagger.yaml` manually; it is found [here](https://github.com/tichex-project/hackatom-cosmos-tichex/blob/master/cmd/gaiacli/swagger-ui/swagger.yaml)
