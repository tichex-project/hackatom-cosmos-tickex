...
Supporting code can be found in the [networks directory](https://github.com/tichex-project/hackatom-cosmos-tichex/tree/master/networks) and additionally the `local` or `remote` sub-directories.
...
From the [networks/local directory](https://github.com/tichex-project/hackatom-cosmos-tichex/tree/master/networks/local):
...
cd $GOPATH/src/github.com/tichex-project/hackatom-cosmos-tichex
...
The following should be run from the [networks directory](https://github.com/tichex-project/hackatom-cosmos-tichex/tree/master/networks).
