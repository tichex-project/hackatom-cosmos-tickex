...
SIMAPP = github.com/tichex-project/hackatom-cosmos-tichex/app
...
sim-gaia-custom-genesis-fast:
	...
	@go test -mod=readonly github.com/tichex-project/hackatom-cosmos-tichex/app -run TestFullGaiaSimulation -SimulationGenesis=${HOME}/.gaiad/config/genesis.json \
...
sim-gaia-fast:
	...
	@go test -mod=readonly github.com/tichex-project/hackatom-cosmos-tichex/app -run TestFullGaiaSimulation -SimulationEnabled=true -SimulationNumBlocks=100 -SimulationBlockSize=200 -SimulationCommit=true -SimulationSeed=99 -SimulationPeriod=5 -v -timeout 24h
...
sim-benchmark-invariants:
	...
	@go test -mod=readonly github.com/tichex-project/hackatom-cosmos-tichex/app -benchmem -bench=BenchmarkInvariants -run=^$ \
...
sim-gaia-benchmark:
	...
	@go test -mod=readonly -benchmem -run=^$$ github.com/tichex-project/hackatom-cosmos-tichex/app -bench ^BenchmarkFullGaiaSimulation$$  \
